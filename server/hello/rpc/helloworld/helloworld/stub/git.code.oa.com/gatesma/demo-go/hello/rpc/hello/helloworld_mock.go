...
// Source: stub/git.code.oa.com/gatesma/demo-go/hello/rpc/hello/helloworld.trpc.go
...
func (m *MockGreeterService) SayHi(ctx context.Context, req *HelloRequest, rsp *HelloReply) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SayHi", ctx, req, rsp)
	ret0, _ := ret[0].(error)
	return ret0
}

// SayHi indicates an expected call of SayHi
func (mr *MockGreeterServiceMockRecorder) SayHi(ctx, req, rsp interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SayHi", reflect.TypeOf((*MockGreeterService)(nil).SayHi), ctx, req, rsp)
}
...
// SayHi mocks base method
func (m *MockGreeterClientProxy) SayHi(ctx context.Context, req *HelloRequest, opts ...client.Option) (*HelloReply, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, req}
	for _, a := range opts {
		varargs = append(varargs, a)
...
// SayHi indicates an expected call of SayHi
func (mr *MockGreeterClientProxyMockRecorder) SayHi(ctx, req interface{}, opts ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, req}, opts...)
